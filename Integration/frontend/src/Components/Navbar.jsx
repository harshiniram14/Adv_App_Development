    ...
    <React.Fragment>
      ...
      <nav className={`navbar ${showNavbar ? 'show' : ''}`}>
        <ul className="nav-list">
          ...
          <li className="nav-item"><Link to="/Addbooking">Add Bookings</Link></li>
          <li className="nav-item"><Link to="/Editbooking">Edit Bookings</Link></li>
          <li className="nav-item"><Link to="/Viewbooking">My Bookings</Link></li>
